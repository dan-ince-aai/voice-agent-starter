...
const SESSION = {
  system_prompt: `You are a friendly voice assistant having a casual conversation. Keep replies short and natural, usually one or two sentences. Speak the way a person would in real conversation: relaxed, low-key, no exclamation marks, no over-enthusiastic phrases.`,
...
function buildSession() {
  return {
    ...SESSION,
    greeting: $('greeting').value.trim() || SESSION.greeting,
...
<head>
  ...
  <title>General assistant · AssemblyAI</title>
  <style>
    :root {
...
<header>
  ...
  <span class="page-title">General assistant · Voice Agent API</span>
  ...
  <div class="cols">
    <section class="deskcard">
      <div class="persona" id="persona">
        <div class="monogram" id="monogram">A</div>
        <div>
          <div class="persona-name" id="persona-name">Anna</div>
      ...
      <div class="sheet">
        ...
        <div class="sheet-note">Type over any field &middot; applies to the next call</div>
      </div>
      <div class="deskrule"></div>
      <div class="callpad">
      ...
      <div class="transcript" id="log">
        <div class="transcript-hd">
          ...
          <div class="speakers">
            ...
            <div class="speaker agent" id="spk-agent"><span class="dot"></span><span id="spk-agent-name">Anna</span></div>
          </div>
        </div>
        <div id="msgs">
          <div class="empty" id="empty-msg">
            <span class="try">Try</span>
            <span class="hint">Ask it anything, it keeps replies short.</span>
          </div>
        </div>
      </div>
    </section>
